enum Soda {
	...
	MOUNTAIN_DEW("Mountain Dew"), DIET_MOUNTIAN_DEW("Diet Mountain Dew"), MOUNTAIN_DEW_CODE_RED("Mountain Dew Code Red"), DIET_MOUNTAIN_DEW_CODE_RED("Diet Mountain Dew Code Red"),
